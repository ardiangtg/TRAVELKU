    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        account.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent toregister = new Intent(com.example.travelkudian.LoginAct.this, RegisterAct.class);
                            ...
                            public void onDataChange( DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (pass.equals(passwordFromfirebase)){
                                        ...
                                        Intent gohome = new Intent(com.example.travelkudian.LoginAct.this, com.example.travelkudian.HomeAct.class);
